/*! For license information please see 124.42bb2a58.chunk.js.LICENSE.txt */
        ...
        function r() {
          ...
          return (
                  ...
                  cellRendererFramework: function (e) {
                    return s.a.createElement(
                      ...
                      s.a.createElement(
                        "div",
                        { className: "" },
                        s.a.createElement("span", null, e.data.blog_title)
                      )
                    );
                  },
                },
                  ...
                  cellRendererFramework: function (e) {
                    return s.a.createElement(
                      ...
                      s.a.createElement(
                        "div",
                        { className: "" },
                        s.a.createElement("span", null, e.data.full_desc)
                      )
                    );
                  },
                },
                {
                  ...
                  cellRendererFramework: function (t) {
                    return s.a.createElement(
                      ...
                      s.a.createElement(S.a, { className: "mr-50", size: 20 }),
            ...
            (e.onGridReady = function (t) {
              (e.gridApi = t.api), (e.gridColumnApi = t.columnApi);
            }),
            (e.filterData = function (t, r) {
              var n = null;
              "all" !== r && (n = { type: "equals", filter: r }),
                e.gridApi.getFilterInstance(t).setModel(n),
                e.gridApi.onFilterChanged();
            }),
            (e.filterSize = function (t) {
              e.gridApi &&
                (e.gridApi.paginationSetPageSize(Number(t)),
                e.setState({ pageSize: t }));
            }),
            (e.updateSearchQuery = function (t) {
              e.gridApi.setQuickFilter(t), e.setState({ searchVal: t });
            }),
            ...
            (e.onEntered = function () {
              e.setState({ status: "Opened" });
            }),
            (e.onEntering = function () {
              e.setState({ status: "Opening..." });
            }),
            (e.onEntered = function () {
              e.setState({ status: "Opened" });
            }),
            (e.onExiting = function () {
              e.setState({ status: "Closing..." });
            }),
            (e.onExited = function () {
              e.setState({ status: "Closed" });
            }),
            (e.removeCard = function () {
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              b.a.get("/allblog").then(function (e) {
                                var r = e.data.data;
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              console.log(t),
                              (e.next = 3),
                              b.a.get("/delblog/".concat(t)).then(function (e) {
                                console.log(e);
                              })
                            );
                          case 3:
                        ...
                        s.a.createElement(
                          ...
                          s.a.createElement(
                            h.a,
                            {
                              ...
                              onClick: function () {
                                return k.a.push("/app/website/blog/addBlog");
                              },
                            },
                            "Add New Blog"
                          )
...
//# sourceMappingURL=124.42bb2a58.chunk.js.map
