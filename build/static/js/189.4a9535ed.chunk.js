/*! For license information please see 189.4a9535ed.chunk.js.LICENSE.txt */
                ...
                },
                {
                  ...
                  cellRendererFramework: function (e) {
                    return s.a.createElement(
                      "div",
                      null,
                      s.a.createElement("span", null, e.data.bannertype)
                    );
                  },
                },
                {
                  ...
                  cellRendererFramework: function (t) {
                    return s.a.createElement(
                      ...
                      s.a.createElement(S.a, {
                        ...
                        onClick: function () {
                          return P.a.push(
                            "/app/freshlist/banner/viewBanner/".concat(
                              t.data._id
                            )
                          );
                        },
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              w.a.get("/getbanner").then(function (e) {
                                var r = e.data.data;
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              console.log(t),
                              (e.next = 3),
                              w.a.get("/delbanner/".concat(t)).then(
                                function (e) {
                                  console.log(e);
                                },
                                function (e) {
...
//# sourceMappingURL=189.4a9535ed.chunk.js.map
