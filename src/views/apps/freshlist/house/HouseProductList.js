            ...
            <Card>
              <Row className="m-2">
                ...
                <Col
                  ...
                  md="2"
                  className="mb-2"
                  style={{ marginTop: "-15px", marginLeft: "29.5rem" }}
                >
                  <Label>Filter</Label>
                  <CustomInput
                    type="select"
                  ...
                  >
                    ...
                    <option value="veg">Category</option>
                    <option value="nonveg">Model</option>
                    <option value="egg">Brand</option>
                    <option value="nonveg">Quantity</option>
                    <option value="egg">Status</option>
                  </CustomInput>
                </Col>
                <Col>
                  <Route
